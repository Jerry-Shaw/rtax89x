...
function genChannel(unit, bwValue){
	...
	var option =  '<option value="0"><#Auto#></option>';
	if(unit == '0'){
...
function genExtChannel(unit, channel, bwValue){
	...
	var bw = bwValTransform[bwValue];
	var option = '<option value="lower"><#Auto#></option>';
	if(unit == '0'){
...
function genMFP(unit , authType, mfpValue){
	...
	if(authType == 'psk2' || authType == 'wpa2'){
		option += '<option value="0"><#WLANConfig11b_WirelessCtrl_buttonname#></option>';
		option += '<option value="1"><#WLANConfig11b_x_mfp_opt1#></option>';
		option += '<option value="2"><#WLANConfig11b_x_mfp_opt2#></option>';
	}
      ...
      <div class="formfontdesc"><#adv_wl_desc#></div>
		<div id="lantiq_ready" style="display:none;color:#FC0;margin-left:5px;font-size:13px;">Wireless is setting...</div>
			<table width="99%" border="1" align="center" cellpadding="4" cellspacing="0" id="WLgeneral" class="FormTable">
			  ...
			  <tr style="display:none">
					<th><a id="band0_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#WLANConfig11b_x_Mode_itemname#></a></th>
					<td>									
			...
			<table width="99%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable" id="band01_table">
				...
				<tr id="band01_closed_field">
					<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#WLANConfig11b_x_BlockBCSSID_itemname#></a></th>
					<td>
						<input type="radio" value="1" name="band01_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl0_closed', '1')" <% nvram_match("wl0_closed", "1", "checked"); %>><#checkbox_Yes#>
						<input type="radio" value="0" name="band01_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl0_closed', '0')" <% nvram_match("wl0_closed", "0", "checked"); %>><#checkbox_No#>
						<!-- <span id="WPS_hideSSID_hint" style="display:none;"></span>	 -->
						<!-- <br> -->
						<!-- <span id="dwb_band_hide_hint"><#AiMesh_dedicated_backhaul_band_hide_SSID#></span> -->
					</td>
				...
				<tr>
					<th><a id="band01_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#WLANConfig11b_x_Mode_itemname#></a></th>
					<td>									
						<select name="band01_nmode_x" class="input_option" onChange="genAuthMethod('01', this.value);">
							<option value="0" <% nvram_match("wl0_nmode_x", "0","selected"); %>><#Auto#></option>
				  ...
				  <tr id="band01_he_mode_field" style="">
					<th>
						<a id="band01_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#WLANConfig11b_HE_Frame_Mode_itemname#></a>
					</th>
					<td>
						<div style="display:flex;align-items: center;">
							<select name="band01_11ax" class="input_option" onChange="he_frame_mode(this);">
								<option value="1" <% nvram_match("wl0_11ax", "1" ,"selected"); %> ><#WLANConfig11b_WirelessCtrl_button1name#></option>
								<option value="0" <% nvram_match("wl0_11ax", "0" ,"selected"); %> ><#WLANConfig11b_WirelessCtrl_buttonname#></option>
							</select>
							<span id="band0_he_mode_faq" style="padding: 0 10px"><#WLANConfig11b_HE_Frame_Mode_faq#></span>
						</div>
					</td>
				</tr>
					...
					<td>
						<div style="width:465px;display:flex;align-items: center;">
							<select name="band01_mbo_enable" class="input_option" >
								<option value="1" <% nvram_match("wl0_mbo_enable", "1","selected"); %>><#WLANConfig11b_WirelessCtrl_button1name#></option>
								<option value="0" <% nvram_match("wl0_mbo_enable", "0","selected"); %>><#WLANConfig11b_WirelessCtrl_buttonname#></option>
							</select>
						</div>
					</td>
				</tr>
					...
					<td>
						<div style="width:465px;display:flex;align-items: center;">
							<select name="band01_twt" class="input_option">
								<option value="1" <% nvram_match("wl0_twt", "1","selected"); %>><#WLANConfig11b_WirelessCtrl_button1name#></option>
								<option value="0" <% nvram_match("wl0_twt", "0","selected"); %>><#WLANConfig11b_WirelessCtrl_buttonname#></option>
							</select>
						</div>
					</td>
				</tr>
				  ...
				  <tr id="band01_wep_x_field" style="display:none">
					...
					<td>
				  		<select name="band01_wep_x" class="input_option" onChange="auth_mehtod_change('01', document.querySelector('[name=\'band01_auth_mode_x\']').value);">
								<option value="0" <% nvram_match("wl0_wep_x", "0", "selected"); %>><#wl_securitylevel_0#></option>
			...
			<table  width="99%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
				...
				<tr id="band0_closed_field">
					<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#WLANConfig11b_x_BlockBCSSID_itemname#></a></th>
					<td>
						<input type="radio" value="1" name="band0_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl0_closed', '1')" <% nvram_match("wl0_closed", "1", "checked"); %>><#checkbox_Yes#>
						<input type="radio" value="0" name="band0_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl0_closed', '0')" <% nvram_match("wl0_closed", "0", "checked"); %>><#checkbox_No#>
						<!-- <span id="WPS_hideSSID_hint" style="display:none;"></span>	 -->
						<!-- <br> -->
						<!-- <span id="dwb_band_hide_hint"><#AiMesh_dedicated_backhaul_band_hide_SSID#></span> -->
					</td>
				...
				<tr id="band0_nmode_x_field">
					...
					<td>									
						...
						<span id="band0_optimizexbox_span" style="display:none"><input type="checkbox" name="band0_optimizexbox_ckb" id="band0_optimizexbox_ckb" value="<% nvram_get("wl0_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#WLANConfig11b_x_Mode_xbox#></input></span>
						<span id="band0_gmode_checkbox"><input type="checkbox" name="band0_gmode_check" id="band0_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#WLANConfig11b_x_Mode_protectbg#></input></span>
						...
						<span id="band0_nmode_x_hint" style="display:none;"><br><#WLANConfig11n_automode_limition_hint#><br></span>
				...
				<tr id="band0_he_mode_field" style="display:none">
					<th>
						<a id="band0_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#WLANConfig11b_HE_Frame_Mode_itemname#></a>
					</th>
					<td>
						<div style="display:flex;align-items: center;">
				...
				<tr id="band0_channel_field">
					<th><a id="band0_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#WLANConfig11b_Channel_itemname#></a></th>
					<td>
						...
						<div style="margin-top:5px">
						<div><span id="band0_acs_ch13_checkbox" style="display:none;"><input id="band0_acs_ch13" type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#WLANConfig11b_EChannel_acs_ch13#></input></span></div>
						</div>
					</td>
			  	</tr>
				...
				<tr id="band1_closed_field">
					<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#WLANConfig11b_x_BlockBCSSID_itemname#></a></th>
					<td>
						<input type="radio" value="1" name="band1_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl1_closed', '1')" <% nvram_match("wl1_closed", "1", "checked"); %>><#checkbox_Yes#>
						<input type="radio" value="0" name="band1_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl1_closed', '0')" <% nvram_match("wl1_closed", "0", "checked"); %>><#checkbox_No#>
						<!-- <span id="WPS_hideSSID_hint" style="display:none;"></span>	 -->
						<!-- <br> -->
						<!-- <span id="dwb_band_hide_hint"><#AiMesh_dedicated_backhaul_band_hide_SSID#></span> -->
					</td>
				...
				<tr id="band1_nmode_x_field">
					<th><a id="band1_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#WLANConfig11b_x_Mode_itemname#></a></th>
					<td>									
						<select name="band1_nmode_x" class="input_option" onChange="genAuthMethod('1', this.value);">
							<option value="0" <% nvram_match("wl1_nmode_x", "0","selected"); %>><#Auto#></option>
						...
						<span id="band1_optimizexbox_span" style="display:none"><input type="checkbox" name="band1_optimizexbox_ckb" id="band1_optimizexbox_ckb" value="<% nvram_get("wl1_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#WLANConfig11b_x_Mode_xbox#></input></span>
						<span id="band1_gmode_checkbox" style="display:none;"><input type="checkbox" name="band1_gmode_check" id="band1_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#WLANConfig11b_x_Mode_protectbg#></input></span>
						...
						<span id="band1_nmode_x_hint" style="display:none;"><br><#WLANConfig11n_automode_limition_hint#><br></span>
				...
				<tr id="band1_he_mode_field" style="display:none">
					<th>
						<a id="band1_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#WLANConfig11b_HE_Frame_Mode_itemname#></a>
					</th>
					<td>
						<div style="display:flex;align-items: center;">
							<select name="band1_11ax" class="input_option" onChange="he_frame_mode(this);">
								<option value="1" <% nvram_match("wl1_11ax", "1" ,"selected"); %> ><#WLANConfig11b_WirelessCtrl_button1name#></option>
								<option value="0" <% nvram_match("wl1_11ax", "0" ,"selected"); %> ><#WLANConfig11b_WirelessCtrl_buttonname#></option>
							</select>
							<span id="band1_he_mode_faq" style="padding: 0 10px"><#WLANConfig11b_HE_Frame_Mode_faq#></span>
						</div>
					</td>
				</tr>
					...
					<td>
						<div style="width:465px;display:flex;align-items: center;">
							<select name="band1_mbo_enable" class="input_option" onChange="handleMFP();">
								<option value="1" <% nvram_match("wl1_mbo_enable", "1","selected"); %>><#WLANConfig11b_WirelessCtrl_button1name#></option>
								<option value="0" <% nvram_match("wl1_mbo_enable", "0","selected"); %>><#WLANConfig11b_WirelessCtrl_buttonname#></option>
							</select>
						</div>
					</td>
				</tr>
					...
					<td>
						<div style="width:465px;display:flex;align-items: center;">
							<select name="band1_twt" class="input_option">
								<option value="1" <% nvram_match("wl1_twt", "1","selected"); %>><#WLANConfig11b_WirelessCtrl_button1name#></option>
								<option value="0" <% nvram_match("wl1_twt", "0","selected"); %>><#WLANConfig11b_WirelessCtrl_buttonname#></option>
							</select>
						</div>
					</td>
				</tr>
				...
				<tr id="band1_channel_field">
					<th><a id="band1_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#WLANConfig11b_Channel_itemname#></a></th>
					<td>
						...
						<div style="margin-top:5px">
						<div><span id="band1_dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="band1_acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#WLANConfig11b_EChannel_dfs#></input></span></div>
						<div><span id="band1_acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#WLANConfig11b_EChannel_band1#></input></span></div>
						<div><span id="band1_acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#WLANConfig11b_EChannel_band3#></input></span></div>
				...
				<tr id="band1_mfp_field" style="">
					...
					<td>
				  		<select name="wl1_mfp" class="input_option" onchange="handleMFP();">
							<option value="0" <% nvram_match("wl1_mfp", "0", "selected"); %>><#WLANConfig11b_WirelessCtrl_buttonname#></option>
				...
				<tr id="band1_wep_x_field" style="display:none">
					...
					<td>
				  		<select name="band1_wep_x" class="input_option" onChange="wepCryptoChange('1', this.value);">
								<option value="0" <% nvram_match("wl1_wep_x", "0", "selected"); %>><#wl_securitylevel_0#></option>
