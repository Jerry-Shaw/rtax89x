	...
	if(obj.id.indexOf("USBdisk") > 0){	// To control USB icon outter ring's color
		if(diskUtility_support){
			if(!usbPorts[obj.id.slice(-1)-1].hasErrPart){
				...
				obj.style.backgroundPosition = '0 -95px';
			}
			else{
		...
		obj.style.backgroundPosition = '35% 100%';
	}
	else if(obj.id.indexOf("AMesh") > 0) {
...
function check_status(_device){
	...
	if(got_code_1){
		// red
		document.getElementById('iconUSBdisk_'+diskOrder).style.backgroundPosition = '0 -206px';
...
function check_dualwan(flag){
	if(flag == 0){		//single wan
		...
		document.getElementById('single_wan_line').style.visibility = "hidden";
		...
		document.getElementById('primary_wan_line').style.display = "";
		document.getElementById('primary_wan_line').style.visibility = "hidden";
		document.getElementById('secondary_wan_line').style.display = "";
		document.getElementById('secondary_wan_line').style.visibility = "hidden";
...
function check_usb3(){
	...
	based_modelid == "MAP-AC3000" || based_modelid == "RT-AC85P" || based_modelid == "RT-AC85U" || based_modelid == "RT-AC65U" || based_modelid == "4G-AC68U" || based_modelid == "BLUECAVE" || based_modelid == "RT-AX92U" || based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "BM68" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "ET8_V2" || based_modelid == "RT-AX56_XD4" || based_modelid == "XD4PRO" || based_modelid == "CT-AX56_XD4" || based_modelid == "RT-AX58U" || based_modelid == "RT-AX58U_V2" || based_modelid == "RT-AX3000N" || based_modelid == "TUF-AX3000" || based_modelid == "TUF-AX3000_V2" || based_modelid == "TUF-AX5400" || based_modelid == "RT-AX82U" || based_modelid == "RT-AX82U_V2" || based_modelid == "RT-AX56U" || based_modelid == "RT-ACRH26" || based_modelid == "GS-AX3000" || based_modelid == "GS-AX5400" || based_modelid == "PL-AX56_XP4" || based_modelid == "GT-AX6000" || based_modelid == "GT-AXE16000" || based_modelid == "TUF-AX4200" || based_modelid == "TUF-AX6000"|| based_modelid == "XC5" || based_modelid == "GT-AX11000_PRO"){
...
<div id="edit_client_block" class="contentM_qis" style="background-color:#000;">
