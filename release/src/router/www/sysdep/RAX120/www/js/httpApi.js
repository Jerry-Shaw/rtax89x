...
var httpApi ={
	...
	*/
	...
	"swrtupdateserver": function(model_info){
		var modelName = (model_info.model_name != undefined) ? model_info.model_name : "";
		if(modelName == "RAX120" || modelName == "RAX70" || modelName == "MR60" || modelName == "MS60" || modelName == "R8000P" || modelName == "360V6" || modelName == "RGMA2820A" || modelName == "RGMA2820B" || modelName == "JDCAX1800" || modelName == "RAX200" || modelName == "TYAX5400" || modelName == "RAX80")
	...
	"getAiMeshLabelMac": function(modelName, macAddr, callBackSuccess, callBackError){
		...
		if(modelName != "Lyra" && modelName != "Lyra_Mini" && modelName != "LyraMini" && modelName != "LYRA_VOICE" && modelName != "Lyra_Trio" && modelName != "GT-AXY16000" && modelName != "RT-AX89X" && modelName != "RAX120" && modelName != "SH-AC1300")
			return;
